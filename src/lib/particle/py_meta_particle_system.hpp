...
public:
	...
	//@{
	static PyObject* createBG( const std::string& filename, PyObject * callback );
	PY_AUTO_MODULE_STATIC_METHOD_DECLARE( RETOWN, createBG, ARG( std::string, ARG( PyObject*, END ) ) )
	//@}
