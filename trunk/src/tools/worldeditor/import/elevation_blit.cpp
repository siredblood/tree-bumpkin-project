    ...
    if (showProgress)
    {
        ...
        importTask  = 
            ...
            ( 
                ...
                L("WORLDEDITOR/WORLDEDITOR/IMPORT/ELEVATION_BLIT/SAVE_TERRAIN_DATA"), 
                length
            );
    }
...
)
{
    ...
    if (showProgress)
    {
        ...
        importTask  = 
            ...
            ( 
                WorldManager::instance().progressBar(), 
                L("WORLDEDITOR/WORLDEDITOR/IMPORT/ELEVATION_BLIT/IMPORT_TERRAIN_DATA"),
				length 
            );
    }
...
)
{
    ...
    if (showProgress)
    {
        ...
        importTask  = 
            ...
            ( 
                WorldManager::instance().progressBar(), 
                L("WORLDEDITOR/WORLDEDITOR/IMPORT/ELEVATION_BLIT/EXPORT_TERRAIN_DATA"), 
				length
            );
    }    
...
)
{
    ...
    if (showProgress)
    {
        ...
        importTask  = 
            ...
            ( 				
                WorldManager::instance().progressBar(), 
                L("WORLDEDITOR/WORLDEDITOR/IMPORT/ELEVATION_BLIT/EXPORT_CALC_HEIGHTS"), 
				length 
            );
    }    
