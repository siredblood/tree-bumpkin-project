...
namespace Moo
{
    ...
    /**
     *  This initializes the image with raw data.  It should only be used
    ...
    /**
     *  Specialization of the Image class for booleans, we pack the booleans
    ...
    {
    	BW_GUARD;
		// This can be optimized quite a bit more if necessary
        if (isEmpty())
            return false;
