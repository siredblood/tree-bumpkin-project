...
/*~ class Pixie.ForcePSA
 *	ForcePSA is a PyParticleSystemAction that applies a constant acceleration to
 *	particles in a particular direction.
 *
 *	A new ForcePSA is created using Pixie.ForcePSA function.
 */
