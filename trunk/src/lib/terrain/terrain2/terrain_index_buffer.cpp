							 ...
							 const Vector2&			morphValue )
{
	...
	PROFILER_BEGIN( TerrainIndexBuffer_SetLodConstants );
 ...
 */
TerrainIndexBuffer* TerrainIndexBuffer::get( uint32 quadCountX, uint32 quadCountZ )
{
	BW_GUARD;
	TerrainIndexBuffer* pBuffer = NULL;
