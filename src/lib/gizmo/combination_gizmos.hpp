...
{
public:
	BoxGizmo( MatrixProxyPtr matrix1, MatrixProxyPtr matrix2, Moo::Colour boxColor = 0xFF0000FF, 
...
{
public:
	LineGizmo( MatrixProxyPtr matrix1, MatrixProxyPtr matrix2, Moo::Colour lineColor = 0xFF0000FF,
		bool drawVectors = false, MatrixProxyPtr originMatrixProxy = NULL,
		int disablerModifiers = MODIFIER_ALT );
	~LineGizmo();
...
{
public:
	CylinderGizmo( MatrixProxyPtr matrix1, MatrixProxyPtr matrix2, FloatProxyPtr radius,
