 ...
 */
class AmpParticleSystemDrawItem : public Aligned, public Moo::ChannelDrawItem
{
public:
	AmpParticleSystemDrawItem( AmpParticleRenderer* renderer, const Matrix& worldTransform, Particles::iterator beg, Particles::iterator end, float distance )
	:	renderer_( renderer ),
	...
	const BoundingBox & inbb )
{
	...
	Moo::SortedChannel::addDrawItem( new AmpParticleSystemDrawItem( this, worldTransform, beg, end, distance ) );
}
