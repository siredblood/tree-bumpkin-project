 ...
 *
 *	There are two types of emitters, non-localized and localized.  A
 *	non-localized fog emitter adds fog to the entire world, causing
 ...
 *
 *	A localized fog emitter causes a camera to add fog to a scene if it is
 ...
 *	radius.  Note that a localized fog emitter does not actually
 ...
 *						Ignored if localized is zero (false).
 ...
 *						Ignored if localized is zero (false).  If the camera
 ...
 *						Ignored if localized is zero (false).  If the camera is
 ...
 *	@param	localized	An integer, treated as a boolean.  If this is true,
 *						then the fogEmitter will be localized, otherwise
 *						it will be non-localized.
 *
