...
/*~ class Pixie.TintShaderPSA
 *
 *	TintShaderPSA is a PyParticleSystemAction that tints a particle according
 ...
 *
 *	A new TintShaderPSA is created using Pixie.TintShaderPSA function.
 */
