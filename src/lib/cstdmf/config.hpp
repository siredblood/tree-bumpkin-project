...
#define FORCE_PREFS_ADJACENT_TO_EXECUTABLE			0
...
#define ENABLE_FILE_CASE_CHECKING		(!CONSUMER_CLIENT_BUILD || FORCE_ENABLE_FILE_CASE_CHECKING)
...
#define PREFS_ADJACENT_TO_EXECUTABLE	(!CONSUMER_CLIENT_BUILD || FORCE_PREFS_ADJACENT_TO_EXECUTABLE)
#define ENABLE_PYTHON_LOG				(!CONSUMER_CLIENT_BUILD || FORCE_ENABLE_PYTHON_LOG)
#define ENABLE_STACK_TRACKER			(!CONSUMER_CLIENT_BUILD || FORCE_ENABLE_STACK_TRACKER)
