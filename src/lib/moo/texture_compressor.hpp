...
private:
	static HRESULT bltAllLevels(ComObjectWrap<DX::Texture>& srcTexture,
								ComObjectWrap<DX::Texture>& destTexture );
	
	static HRESULT changeFormat(ComObjectWrap<DX::Texture>& srcTexture,
								ComObjectWrap<DX::Texture>& destTexture,
