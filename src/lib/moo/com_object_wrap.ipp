...
void ComObjectWrap<COMOBJECTTYPE>::release()
{
	...
	if (comObject_ != NULL)
	{
		...
		extern void ProfileD3DResourceRelease( uint64 deltatime );
		uint64 dt = timestamp();
#endif	
		comObject_->Release();
		comObject_ = NULL;
...
#if PROFILE_D3D_RESOURCE_RELEASE
		dt = timestamp() - dt;	
		ProfileD3DResourceRelease( dt );
#endif	
	}	
}

// Specializations of pool and size for various DirectX components
#if ENABLE_RESOURCE_COUNTERS
 ...
 *							This is specialized for many object types,
 *							but needs to be specialized for any
 *							future types.
 */
template<typename COMOBJECTTYPE>
...
/**
 *	This is the specialization of pool for effects.
 */
...
/**
 *	This is the specialization of size for effects.
 */
...
/**
 *	This is the specialization of pool for vertex buffers.
 */
...
/**
 *	This is the specialization of size for vertex buffers.
 */
...
/**
 *	This is the specialization of pool for index buffers.
 */
...
/**
 *	This is the specialization of size for index buffers.
 */
...
/**
 *	This is the specialization of pool for textures.
 */
...
/**
 *	This is the specialization of size for textures.
 */
