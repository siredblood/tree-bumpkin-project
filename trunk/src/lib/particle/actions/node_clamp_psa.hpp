...
/*~ class Pixie.NodeClampPSA
 *
 *	NodeClampPSA is a PyParticleSystemAction that locks a particle to the Node
 ...
 *
 *	A new NodeClampPSA is created using Pixie.NodeClampPSA function.
 */
