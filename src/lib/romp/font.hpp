...
/**
 * The Font class confict with the font of the comdef.h, so add a namespace to it
 */
 ...
 */
class CachedFont : public BwFont::Font
{
public:
private:
	...
	//friend used so constructor may be private, ensuring
	//fonts are only created via the FontManager.
	friend class BwFont::FontManager;
};
 ...
 */
class HTMLFont: public BwFont::Font
{
};
