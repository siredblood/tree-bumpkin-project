...
namespace TerrainUtils
{
    ...
    {
		TerrainFormat();
        float           poleSpacingX;   // Spacing between poles in meters in x-direction
        float           poleSpacingY;   // Spacing between poles in meters in y-direction
        float           widthM;         // Width of block in meters
        float           heightM;        // Height of block in meters
