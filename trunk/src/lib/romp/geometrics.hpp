...
public:
	...
	//添加了绘制贴图
	static void drawTexRect( const Vector2& topLeft,
		const Vector2& bottomRight,
		Moo::BaseTexturePtr pTex);

	static void drawTexRect( const Vector2& topLeft,
		const Vector2& bottomRight,
		Moo::BaseTexturePtr pTex, bool alpha );
	...
	//添加了创建直线
	static void createLineMesh( const Vector2& pt1, 
		const Vector2& pt2, 
	...
	static void Geometrics::createRectMesh( const Vector2& topLeft,
		const Vector2& bottomRight,
		const Moo::Colour& colour,
		bool linearUV, 
	...
	//添加绘制平面直线
	static void drawLine( const Vector2& pt1, 
		const Vector2& pt2, 
		const Moo::Colour& colour ); 
	...
	static void drawLine( std::vector<Vector3> vPoints,
			const Moo::Colour& colour = Moo::Colour( 1, 0, 0, 0 ));
			
	static void drawLine( std::vector<Vector3> vPoints, int iSectionSize, const Moo::Colour& colour = Moo::Colour( 1, 0, 0, 0 ));
	...
	//增加的函数,画面
	static void drawRect(Vector3 p1,Vector3 p2, Vector3 p3, Vector3 p4, const Moo::Colour& colour);
	static void drawRegion( std::vector<Vector3> vRegionPt, const Moo::Colour& colour);
	static void drawRegion( std::vector<Vector3> vRegionPt, Vector3 mousept, const Moo::Colour& colour);
	
	static void drawAngle(Vector3 FirPt, Vector3 SecPt, Vector3 ThirPt, const Moo::Colour& colour);
