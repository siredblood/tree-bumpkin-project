...
bool EditorChunkSound::edEdit( class ChunkItemEditor & editor )
{
	editor.addProperty( new GenBoolProperty(
		L("WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_SOUND/THREED"),
	...
	editor.addProperty( new ResourceProperty(
		L("WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_SOUND/RESOURCE"),
	...
	editor.addProperty( new GenPositionProperty(
		L("WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_SOUND/POSITION"), pMP ) );

	editor.addProperty( new GenRadiusProperty(
		L("WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_SOUND/INNER_RADIUS"),
		new AccessorDataProxy<EditorChunkSound,FloatProxy>(
			this, "inner radius", 
			&EditorChunkSound::innerRadiusGet, 
			&EditorChunkSound::innerRadiusSet ), pMP ) );
	editor.addProperty( new GenRadiusProperty(
		L("WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_SOUND/OUTER_RADIUS"),
		new AccessorDataProxy<EditorChunkSound,FloatProxy>(
			this, "outer radius", 
	...
	editor.addProperty( new GenFloatProperty(
		L("WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_SOUND/ATTENUATION"),
		new AccessorDataProxy<EditorChunkSound,FloatProxy>(
			this, "attenuation", 
			&EditorChunkSound::attenuationGet, 
			&EditorChunkSound::attenuationSet ) ) );
	editor.addProperty( new GenFloatProperty(
		L("WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_SOUND/OUTSIDE_EXTRA_ATTENUATION"),
		new AccessorDataProxy<EditorChunkSound,FloatProxy>(
			this, "outside extra attenutation",
			&EditorChunkSound::outsideAttenGet, 
			&EditorChunkSound::outsideAttenSet ) ) );
	editor.addProperty( new GenFloatProperty(
		L("WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_SOUND/INSIDE_EXTRA_ATTENUATION"),
		new AccessorDataProxy<EditorChunkSound,FloatProxy>(
			this, "inside extra attenutation",
			&EditorChunkSound::insideAttenGet, 
			&EditorChunkSound::insideAttenSet ) ) );
	editor.addProperty( new GenFloatProperty(
		L("WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_SOUND/CENTRE_HOUR"),
		new AccessorDataProxy<EditorChunkSound,FloatProxy>(
			this, "centre hour", 
			&EditorChunkSound::centreHourGet, 
			&EditorChunkSound::centreHourSet ) ) );
	editor.addProperty( new GenFloatProperty(
		L("WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_SOUND/INNER_HOUR"),
		new AccessorDataProxy<EditorChunkSound,FloatProxy>(
			this, "inner hours", 
			&EditorChunkSound::innerHoursGet, 
			&EditorChunkSound::innerHoursSet ) ) );
	editor.addProperty( new GenFloatProperty(
		L("WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_SOUND/OUTER_HOUR"),
		new AccessorDataProxy<EditorChunkSound,FloatProxy>(
			this, "outer hours", 
	...
	editor.addProperty( new GenBoolProperty(
		L("WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_SOUND/LOOP"),
		new SlowPropReloadingProxy<EditorChunkSound,BoolProxy>(
			this, "loop enable flag", 
			&EditorChunkSound::loopGet, 
			&EditorChunkSound::loopSet ) ) );
	editor.addProperty( new GenFloatProperty(
		L("WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_SOUND/LOOP_DELAY"),
		new SlowPropReloadingProxy<EditorChunkSound,FloatProxy>(
			this, "loop delay", 
			&EditorChunkSound::loopDelayGet, 
			&EditorChunkSound::loopDelaySet ) ) );
	editor.addProperty( new GenFloatProperty(
		L("WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_SOUND/LOOP_DELAY_VARIANCE"),
		new SlowPropReloadingProxy<EditorChunkSound,FloatProxy>(
