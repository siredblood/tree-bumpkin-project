	...
	pItem_( pItem )
{
	...
	lastItemName_ = L( "WORLDEDITOR/WORLDEDITOR/PROPERTIES/ITEM_EDITOR/LAST_ITEM_NAME",
		pItem_->edDescription(), pItem_.getObject() );

	this->addProperty( new StaticTextProperty( L( "WORLDEDITOR/WORLDEDITOR/PROPERTIES/ITEM_EDITOR/CHUNK"), 
