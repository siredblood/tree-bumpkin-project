...
/**
 *	This method applies the viewport on the device, taking care
 *	to recalculate the view and projection matrices and update
 *	the screen width and height settings.
 *
