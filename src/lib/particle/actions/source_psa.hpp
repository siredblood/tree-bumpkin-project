...
public:
	...
	//@}
	virtual void setFirstUpdate() { firstUpdate_ = true; }
...
/*~ class Pixie.SourcePSA
 *
 *	SourcePSA is a PyParticleSystemAction that creates particles within
 ...
 *
 *	A new SourcePSA is created using Pixie.SourcePSA function.
 */
