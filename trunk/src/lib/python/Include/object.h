...
#ifdef DEBUG_REFS
	extern void intercept_incref(void * object);
	extern void intercept_decref(void * object);
	#define INTERCEPT_INCREF(object) intercept_incref(object),
	#define INTERCEPT_DECREF(object) intercept_decref(object),
#else // DEBUG_REFS
	#define INTERCEPT_INCREF(object)
	#define INTERCEPT_DECREF(object)
#endif // DEBUG_REFS
