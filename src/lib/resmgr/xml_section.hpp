...
protected:
	...
	//@{
	virtual bool setBool( bool value, const char *format );
	virtual bool setInt( int value, const char *format );
	virtual bool setLong( long value, const char *format );
	virtual bool setFloat( float value, const char *format );
	virtual bool setDouble( double value, const char *format );
	virtual bool setString( const std::string &value );
	virtual bool setWideString( const std::wstring &value );
	virtual bool setVector2( const Vector2 &value, const char *format );
	virtual bool setVector3( const Vector3 &value, const char *format );
	virtual bool setVector4( const Vector4 &value, const char *format );
	virtual bool setMatrix34( const Matrix &value, const char *vectorFormat );
