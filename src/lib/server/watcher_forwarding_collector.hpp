 ...
 */
class ForwardingCollector : public Mercury::ReplyMessageHandler
{
public:
	...
	bool init( const Mercury::InterfaceElement & ie, Mercury::Nub & nub,
...
private:
	...
	Mercury::Nub *pNub_;	//!< Nub the messages should be sent through.
