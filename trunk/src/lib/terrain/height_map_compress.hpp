...
namespace Terrain
{
	 ...
	 *	BinaryBlock.  The heights can be quantized, and so there is a little 
	 ...
	 *	quantizing the heights to 1mm intervals and compressing the resultant 
	 *	integerized height map using PNG.  Typically this gives a compression 
	 *	ratio of 8:1.
	 */
