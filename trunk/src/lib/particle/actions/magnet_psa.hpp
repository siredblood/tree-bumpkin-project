...
/*~ class Pixie.MagnetPSA
 *
 *	The MagnetPSA PyParticleSystemAction sets up an acceleration on particles
 *	towards a particular point (magnitude based upon the square of the distance
 *	from that point).
 *
 *	A new MagnetPSA is created using Pixie.MagnetPSA function.
 *
 */
