 ...
 *	Get length
 */
int PySTLSequence::pySeq_length()
{
	return holder_.size();
}
 ...
 */
PyObject * PySTLSequence::pySeq_repeat( int n )
{
 ...
 */
PyObject * PySTLSequence::pySeq_item( int index )
{
	int sz = holder_.size();
 ...
 *	Get the given slice
 */
PyObject * PySTLSequence::pySeq_slice( int indexA, int indexB )
{
	int sz = holder_.size();
 ...
 */
int PySTLSequence::pySeq_ass_item( int index, PyObject * pItem )
{
 ...
 */
int PySTLSequence::pySeq_ass_slice( int indexA, int indexB, PyObject * pOther )
{
	// check that the holder is writable
	if (!holder_.writable())
	{
 ...
 */
PyObject * PySTLSequence::pySeq_inplace_repeat( int n )
{
	// check that the holder is writable
	if (!holder_.writable())
	{
