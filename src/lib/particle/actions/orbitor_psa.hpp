...
private:
	...
	std::map<size_t, Vector3> indexedOrbits_;
	//@}
};
...
/*~ class Pixie.OrbitorPSA
 *
 *	OrbitorPSA is a PyParticleSystemAction that causes particles to orbit
 *	around a point.
 *
 *	A new OrbitorPSA is created using Pixie.OrbitorPSA function.
 */
