...
public:
	...
	void addPySkyDome( PyModelPtr model, Vector4ProviderPtr provider );
	void delPySkyDome( PyModelPtr model, Vector4ProviderPtr provider );
...
private:
	...
	std::vector<PyModelPtr>		pySkyDomes_;	
	Vector4				        thunder_;
