 ...
 */
class TrailParticleSystemDrawItem : public Moo::ChannelDrawItem, public Aligned
{
public:
	TrailParticleSystemDrawItem( TrailParticleRenderer* renderer, const Matrix& worldTransform, Particles::iterator beg, Particles::iterator end, float distance )
	:	renderer_( renderer ),
...
private:
	TrailParticleRenderer* renderer_;
	...
	const BoundingBox & inbb )
{
	...
	Moo::SortedChannel::addDrawItem( new TrailParticleSystemDrawItem( this, worldTransform, beg, end, distance ) );
}
