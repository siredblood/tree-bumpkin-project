...
/*~ class Pixie.FlarePSA
 *	FlarePSA is a PyParticleSystemAction that draws a lens flare at
 ...
 *	is specified when the FlarePSA is created using the FlarePSA factory
