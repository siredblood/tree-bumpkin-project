...
const std::string PageChunkWatcher::contentID = "PageChunkWatcher";
...
{
	std::string mouseText = L("WORLDEDITOR/GUI/PAGE_CHUNK_WATCHER/POSITION");
	std::string chunkText = L("WORLDEDITOR/GUI/PAGE_CHUNK_WATCHER/CHUNK");
