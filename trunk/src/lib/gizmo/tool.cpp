...
/**
 *	Handle a key event coming from python
 */
PyObject * Tool::py_handleKeyEvent( PyObject * args )
{
	KeyEvent	ke;
...
/**
 *	Handle a mouse event coming from python
 */
PyObject * Tool::py_handleMouseEvent( PyObject * args )
{
	MouseEvent	me(0,0,0);
