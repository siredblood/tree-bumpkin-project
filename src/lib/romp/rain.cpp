 ...
 transiting_( true )
{
	...
	static bool watchingRain = false;
	if (!watchingRain)
	{
 ...
 */
void Rain::update( const struct WeatherSettings & ws, bool outside )
{
	// TODO: Use wind_ properly ... as a velocity!
	wind_ = Vector3( ws.windX, 0, ws.windZ ) / 50.f;
