...
/*~ class Pixie.BarrierPSA
 *
 *	BarrierPSA is a PyParticleSystemAction that acts as an invisible barrier
 ...
 *	for each BarrierPSA.
 *
 *	A new BarrierPSA is created using Pixie.BarrierPSA function.
 */
