...
#define PY_INTINTARG_FUNC_METHOD( METHOD_NAME )								\
	PyObject * METHOD_NAME( int a, int b );									\
	static PyObject * _##METHOD_NAME( PyObject * self, Py_ssize_t a, Py_ssize_t b )		\
	{																		\
		return ((This*)self)->METHOD_NAME( a, b );							\
	}
...
#define PY_INTOBJARG_PROC_METHOD( METHOD_NAME )								\
	int METHOD_NAME( int a, PyObject * b );									\
...
#define PY_INTINTOBJARG_PROC_METHOD( METHOD_NAME )							\
	int METHOD_NAME( int a, int b, PyObject * c );							\
	static int _##METHOD_NAME( PyObject * self, Py_ssize_t a, Py_ssize_t b, PyObject * c )\
	{																		\
...
/**
 *	Macros to automatically parse arguments out of python
 */
...
#define PY_TYPEOBJECT( THIS_CLASS )											\
	PY_GENERAL_TYPEOBJECT( THIS_CLASS, 0, 0, 0, 0, 0 )

#define PY_TYPEOBJECT_WITH_DOC( THIS_CLASS, DOC )							\
	PY_GENERAL_TYPEOBJECT_WITH_DOC( THIS_CLASS, 0, 0, 0, 0, 0, DOC )

/// This high-level macro defines a type object with sequence methods
#define PY_TYPEOBJECT_WITH_SEQUENCE( THIS_CLASS, SEQ )						\
	PY_GENERAL_TYPEOBJECT( THIS_CLASS, SEQ, 0, 0, 0, 0 )

#define PY_TYPEOBJECT_WITH_SEQUENCE_WITH_DOC( THIS_CLASS, SEQ, DOC )		\
	PY_GENERAL_TYPEOBJECT_WITH_DOC( THIS_CLASS, SEQ, 0, 0, 0, 0, DOC )

/// This high-level macro defines a type object with mapping methods
#define PY_TYPEOBJECT_WITH_MAPPING( THIS_CLASS, MAP )						\
	PY_GENERAL_TYPEOBJECT( THIS_CLASS, 0, MAP, 0, 0, 0 )

#define PY_TYPEOBJECT_WITH_MAPPING_WITH_DOC( THIS_CLASS, MAP, DOC )			\
	PY_GENERAL_TYPEOBJECT_WITH_DOC( THIS_CLASS, 0, MAP, 0, 0, 0, DOC )

/// This high-level macro defines a type object with a call method
#define PY_TYPEOBJECT_WITH_CALL( THIS_CLASS )								\
	PY_GENERAL_TYPEOBJECT( THIS_CLASS, 0, 0, _pyCall, 0, 0 )

#define PY_TYPEOBJECT_WITH_CALL_WITH_DOC( THIS_CLASS, DOC )					\
	PY_GENERAL_TYPEOBJECT_WITH_DOC( THIS_CLASS, 0, 0, _pyCall, 0, 0, DOC )

/// This macro defines a type object that supports the iterator protocol
#define PY_TYPEOBJECT_WITH_ITER( THIS_CLASS, ITER, ITERNEXT )				\
	PY_GENERAL_TYPEOBJECT( THIS_CLASS, 0, 0, 0, ITER, ITERNEXT )

#define PY_TYPEOBJECT_WITH_ITER_WITH_DOC( THIS_CLASS, ITER, ITERNEXT, DOC )	\
	PY_GENERAL_TYPEOBJECT_WITH_DOC( THIS_CLASS, 0, 0, 0, ITER, ITERNEXT, DOC )

/// This low-level macro defines the PyTypeObject for this class.
#define PY_GENERAL_TYPEOBJECT( THIS_CLASS, SEQ, MAP, CALL, ITER, ITERNEXT )	\
	PY_GENERAL_TYPEOBJECT_WITH_BASE( THIS_CLASS, SEQ, MAP, CALL,			\
		ITER, ITERNEXT, &Super::s_type_ )									\

#define PY_GENERAL_TYPEOBJECT_WITH_DOC( THIS_CLASS, SEQ, MAP, CALL, ITER, ITERNEXT )	\
	PY_GENERAL_TYPEOBJECT_WITH_BASE_WITH_DOC( THIS_CLASS, SEQ, MAP, CALL,	\
		ITER, ITERNEXT, &Super::s_type_, DOC )								\

#define PY_GENERAL_TYPEOBJECT_WITH_BASE( THIS_CLASS, SEQ, MAP, CALL,		\
			ITER, ITERNEXT, BASE )											\
	PY_GENERAL_TYPEOBJECT_WITH_BASE_WITH_DOC( THIS_CLASS, SEQ, MAP, CALL,	\
		ITER, ITERNEXT, BASE, 0 )											\

#define PY_GENERAL_TYPEOBJECT_WITH_BASE_WITH_DOC( THIS_CLASS, SEQ, MAP,		\
		CALL, ITER, ITERNEXT, BASE, DOC )									\
																			\
