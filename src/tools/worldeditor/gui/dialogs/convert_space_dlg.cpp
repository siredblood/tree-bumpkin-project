...
void ConvertSpaceDlg::OnBnClickedOk()
{
	...
	Options::setOptionInt( "terrain2/defaults/heightMapSize", atoi( buffer ) );
	normalMapSize_.GetLBText( normalMapSize_.GetCurSel(), buffer );
	Options::setOptionInt( "terrain2/defaults/normalMapSize", atoi( buffer ) );
	...
	Options::setOptionInt( "terrain2/defaults/shadowMapSize", atoi( buffer ) );
