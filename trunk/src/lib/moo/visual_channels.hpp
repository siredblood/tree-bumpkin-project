...
public:
	...
	virtual void addItem( VertexSnapshotPtr pVSS, PrimitivePtr pPrimitives, 
		...
		Moo::VertexBuffer pStaticVertexColours ) = 0;
...
public:
	void init( 
		...
		Moo::VertexBuffer pStaticVertexColours = Moo::VertexBuffer(), 
