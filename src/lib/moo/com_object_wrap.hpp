...
// Enable d3d release profiling only when StackTracking is enabled.
#if ENABLE_STACK_TRACKER && !defined( EDITOR_ENABLED )
#define PROFILE_D3D_RESOURCE_RELEASE 1
#else
#define PROFILE_D3D_RESOURCE_RELEASE 0
#endif
