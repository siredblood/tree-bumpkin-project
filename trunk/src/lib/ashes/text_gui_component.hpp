...
public:
	TextGUIComponent( BwFont::FontPtr font = s_defFont(), PyTypePlus * pType = &s_type_ );
	~TextGUIComponent();
	...
	static BwFont::FontPtr		s_defFont();
...
protected:
	...
	COMPONENT_FACTORY_DECLARE( TextGUIComponent(s_defFont()) )
};
