...
public:
	...
	//×Ô¶¨Òå
	virtual std::string getParticularPath() { return resourceName_; }
	static std::map<std::string, std::set<EditorChunkParticleSystem*> > getParticularMap() { return editorChunkParticleSystem_; }
	void setShow( bool b ) { bShow_ = b; }
