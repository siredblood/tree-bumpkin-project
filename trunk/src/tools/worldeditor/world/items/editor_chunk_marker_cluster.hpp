...
public:
	...
	std::string edDescription() { return L("WORLDEDITOR/WORLDEDITOR/CHUNK/EDITOR_CHUNK_MARK_CLUSTER/ED_DESCRIPTION"); }
	...
	uint32 getAvailableMarkers() const { return availableMarkers_; }
	bool setAvailableMarkers(const uint32& number);
