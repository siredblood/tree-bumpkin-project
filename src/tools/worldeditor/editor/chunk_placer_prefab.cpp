...
PyObject* ChunkPlacer::py_saveChunkPrefab( PyObject * args )
{
	...
	*/
	...
	std::string returnMessage = L( "WORLDEDITOR/WORLDEDITOR/CHUNK/CHUNK_PLACER_PREFAB/SAVED_PREFAB_MSG", prefabName );
...
PyObject* ChunkPlacer::py_loadChunkPrefab( PyObject * args )
{
	...
	if ( !success )
	{
		UndoRedo::instance().barrier( L( "WORLDEDITOR/WORLDEDITOR/CHUNK/CHUNK_PLACER_PREFAB/LOAD_PREFAB_BARRIER" ), false );
