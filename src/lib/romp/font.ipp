...
INLINE FontMetrics& BwFont::Font::metrics()
{
	return metrics_;
}


INLINE void BwFont::Font::fitToScreen( bool state, const Vector2& numCharsXY )
{
	fitToScreen_ = state;
...
INLINE bool BwFont::Font::fitToScreen() const
{
	return fitToScreen_;
}
