...
inline bool isFloatValid( float f )
{
	...
	*/
		#define DECLARE_DEBUG_COMPONENT2( module, priority )					\
			...
			static WatcherPtr neverUseThisDataWatcherPointer =					\
...
// To avoid issues with smarthpointer.hpp and binary_stream.ipp including
// debug.hpp and re-triggering watcher.hpp to be included, the .ipp defines
// the following so it can be avoided.
#ifndef BS_NO_WATCHER_INCLUDE
#include "watcher.hpp"
#endif
