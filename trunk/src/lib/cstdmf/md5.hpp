...
// -----------------------------------------------------------------------------
// Section: Start of original md5.h
// -----------------------------------------------------------------------------
...
/* BigWorld: Don't declare these functions here because they clash with Python
 * which has its own copy of these functions */
#if 0
