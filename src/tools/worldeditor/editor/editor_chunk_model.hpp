...
public:
	...
	virtual void edSetCastsShadow(const bool & b) { castsShadow_ = b; }     //change 2010-3-5 设置阴影
	virtual std::string edGUID() { 	return guid_.toString(); }              //change 2010-3-4 返回已有GUID
	virtual void edSetGUID(const std::string & s) { guid_ = UniqueID(s); }	//change 2010-3-4 设置GUID
...
private:
	...
	UniqueID guid_;		  //change 2010-3-3 模型GUID
