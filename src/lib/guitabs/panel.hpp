...
/**
 *	GUI Tearoff panel framework - Panel class
 */
...
public:
	...
	void addTab( const std::string contentID );
	void addTab( TabPtr tab );
	void detachTab( TabPtr tab );
	void detachTab( const std::string contentID );
	...
	int contains( const std::string contentID );
	ContentPtr getContent( const std::string contentID );
	ContentPtr getContent( const std::string contentID, int& index );
	...
	void showTab( const std::string contentID, bool show );
	void showTab( ContentPtr content, bool show );
	bool isTabVisible( const std::string contentID );
...
private:
	...
	int tabContains( TabPtr t, const std::string contentID );
